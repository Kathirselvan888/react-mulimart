    ...
    <Helmet title={productName}>
      ...
      <section>
        <Container>
          <Row>
            <Col lg="12">
              <div className="tab_wrapper d-flex align-ites-center gap-5">
              ...
              {
                tab === 'desc' ? <div className="tab_content mt-4"> <p>{description}</p></div> : <div className="product_review">
                  <div className="riview_wrapper mt-4">
                    <ul>
                      {
                        reviews.map((item, index) => (
                          <li key={index} className='mb-4'><h6>Jhon Deo</h6><span>{item.rating} (rating)</span>
                            <p>{item.text}</p>
                          </li>
                        ))
                      }
                    ...
                    <div className="review_form">
                      ...
                      <form action="" onClick={submitHandler}>
                        ...
                        <div className="form_group">
                          <textarea ref={reviewMsg} rows={4} required type="text" placeholder='Review messages...'/>
                        </div>

        ...
        <Container>
          <Row>
            ...
            <Col lg="3">
              ...
              <div>
                <button className="buy_btn w-100 mt-3"><Link to='/shop'>Continue Shop</Link></button>
              </div>
            </Col>
          </Row>
        </Container>
...
const Tr = ({item}) => {
  ...
  return <tr>
    ...
    <motion.td onClick={deleteProduct} whileTap={{ scale: 1.2 }}><i class="ri-delete-bin-line"></i></motion.td>
  </tr>
}
